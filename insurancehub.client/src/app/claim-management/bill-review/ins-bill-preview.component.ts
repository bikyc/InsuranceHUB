...
import { ENUM_CreditModule, ENUM_INSHTTPResponseText, ENUM_MessageBox_Status } from '../../shared/shared-enums';
...
import { PharmacyCreditNote_DTO } from '../../shared/DTOs/pharmacy-credit-note.dto';
...
export class InsBillPreviewComponent implements OnInit {
  ...
  public editBillItemStatus: boolean = false
  ...
  public hotkeys(event: KeyboardEvent): void {
    if (event.keyCode === 27) {
