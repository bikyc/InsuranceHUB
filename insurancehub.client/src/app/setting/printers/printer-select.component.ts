...
import { PrinterSettingsModel } from "./select-printer/printer-settings.model";
...
export class PrinterSelectComponent {
    ...
    public selPrinterObj: PrinterSettingsModel = new PrinterSettingsModel();
    ...
    ngOnInit() {
        ...
        this.selPrinterObj = new PrinterSettingsModel();
        if (this.groupName) {
        ...
        if (prntrInStorage) {
            ...
            this.selPrinterObj = this.allPrinters.find(p => p.PrinterSettingId == this.printerSettId)|| new PrinterSettingsModel();
        }
        else {
