...
import { ENUM_DateRangeName } from '../shared-enums';
...
export class FromToDateSelectComponent implements AfterViewInit {
  showTimeOptionBtn: boolean = false;
  showTimeBtn: any;
  ...
  public calendarType: string = 'np';//default is np- change it after global settings later on.

  public showNpCalendar: boolean = true;//default is np calendar..
  public showEnCalendar: boolean = false;

  public npDate_from: NepaliDate = new NepaliDate();
  public npDate_to: NepaliDate = new NepaliDate();
  ...
  @Output('on-change')
  onDateChange = new EventEmitter<DateChangeEvent>();
  ...
  defaultRangeName: string = '';//null by default.
  ...
  onDateFromChange(value: string) {
    this.enDate_from = value;
    this.EngCalendarOnDateChange_From();
  }
  ...
  onDateToChange(value: string) {
    this.enDate_to = value;
    this.EngCalendarOnDateChange_To();
  }
  ...
  public validationObject = { isValid: true, errorMessages: [] as string[] };
