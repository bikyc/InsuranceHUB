...
export class DatePickerComponent implements ControlValueAccessor, OnChanges {
  ...
  public inputFocusToEnCalendar: boolean = false;
  public inputFocusToNpCalendar: boolean = false;

  public outputToParent: boolean = false;
  ...
  //values can be: 'SoftwareStart' ,  'DateOfBirth', check in nepali-calendar component for all othe available options.
  @Input("year-settings")
